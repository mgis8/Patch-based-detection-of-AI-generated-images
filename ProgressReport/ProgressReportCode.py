...
currentPatchSize = 128
currentTrainDataLoader = train_dataloader128
currentValDataLoader = val_dataloader128
currentTestDataLoader = test_dataloader128
...
model = NaiveNeuralNetwork().to(device)
